...
{
    TORCH_CHECK(cam_comm_init(comm_id, rank, group_size, serverIpPort), "[ERROR] [CAM] cam_comm_init failed!!!!!");
    Moe::CamComm *cam_comm(static_cast<Moe::CamComm *>(g_comms[comm_id]));
    auto comm_size = sizeof(Moe::CommArgs);
